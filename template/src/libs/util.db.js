...
const adapter = new LocalStorage(`${process.env.VUE_APP_STORAGE_PREFIX}-${process.env.VUE_APP_VERSION}`, {
  serialize: (data) => isDev ? JSON.stringify(data) : escape(JSON.stringify(data)),
  deserialize: (data) => isDev ? JSON.parse(data) : JSON.parse(unescape(data))
})
...
export function dbGet({
  ...
  return new Promise(resolve => {
    resolve(_.cloneDeep(db.get(pathInit({
      dbName,
      path,
      user,
      defaultValue
